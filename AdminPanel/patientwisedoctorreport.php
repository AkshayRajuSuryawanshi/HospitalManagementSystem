                               ...
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    <nav class="nav">
                                      ...
                                      <a class="nav-link" href="materialreturnentry.php">COUNTER CASH RETURN</a>
                                      <a class="nav-link" href="purchasereturn.php">COUNTER CASH RECEIVE</a>
                                      <a class="nav-link" href="supplierpayment.php">PATIENT WISE DOCTOR REPORT</a>
                                     </nav>
                                </div>
                                <div class="card-body">
                                    <div class="row">
