                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <select  class="form-control">
                                            ...
                                            <option>OM Enterprizes</option>
                                        </select>
                                         </div>
                                         <div class="col-xl-3">   
                                         <div class="input-group mb-3">
                                        <label class="form-control text-primary fw-bold">BILL GRN NO</label>
                                        <input type="text" class="form-control" >
                                         </div>
                                         <div class="col-xl-3">   
                                         <div class="input-group mb-3">
                                        <label class="form-control text-primary fw-bold">BILL GRN DATE</label>
                                         <input type="text" class="form-control" value="23/10/2023">
                                         </div>
                                         </div>
                                         <button type="button" class="btn btn-primary">SEARCH GRN</button>
                                        ...
                                        <select  class="form-control">
                                            <option>-Select Material  Uom-</option>
                                            <!-- <option>OM Enterprizes</option> -->
                                        </select>
                                         </div>
                                         <div class="col-xl-3">   
                                         <div class="input-group mb-3">
                                        <label class="form-control text-primary fw-bold">STORE</label>
                                        <select  class="form-control">
                                            <option>-Select Material  Uom-</option>
                                            <!-- <option>OM Enterprizes</option> -->
                                        </select>
                                         ...
                                         <div class="col-xl-3">   
                                         <div class="input-group mb-3">
                                        <label class="form-control text-primary fw-bold">PUR. QTY</label>
                                         <input type="text" class="form-control" value="23/10/2023">
                                         </div>
                                         </div><div class="col-xl-3">   
                                         <div class="input-group mb-3">
                                        <label class="form-control text-primary fw-bold">UNIT/QTY</label>
                                         <input type="text" class="form-control" value="23/10/2023">
                                         </div>
                                         </div>
                                         <div class="col-xl-3">   
                                         <div class="input-group mb-3">
                                        <label class="form-control text-primary fw-bold">BATCH NO</label>
                                         <input type="text" class="form-control" value="23/10/2023">
                                         </div>
                                         </div>
                                         <div class="col-xl-3">   
                                         <div class="input-group mb-3">
                                        <label class="form-control text-primary fw-bold">FREE QTY</label>
                                         <input type="text" class="form-control" value="23/10/2023">
                                         </div>
                                         </div>
                                         <div class="col-xl-3">   
                                         <div class="input-group mb-3">
                                        <label class="form-control text-primary fw-bold">TOTAL QTY</label>
                                         <input type="text" class="form-control" value="23/10/2023">
                                         </div>
                                         </div>
                                         <div class="col-xl-3">   
                                        ...
                                        <label class="form-control text-primary fw-bold">TAX AMT</label>
                                         ...
                                         <div class="input-group mb-3">
                                        <label class="form-control text-primary fw-bold">BILL GRN DATE</label>
                                         <input type="date" class="form-control" value="23/12/2023" >
                                         </div>
                                        
                                         </div>
                                         <button type="button" class="btn btn-primary">SEARCH OLD GRN</button>
