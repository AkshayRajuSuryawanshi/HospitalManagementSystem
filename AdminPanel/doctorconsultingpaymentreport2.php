                               ...
                               <div class="col-xl-12">
                                ...
                                <div class="card-header">
                                    <nav class="nav">
                                      ...
                                      <a class="nav-link" href="pettycashtransaction.php">PETTY CASH TRANSACTION</a>
                                      <a class="nav-link" href="countercashreturn.php">COUNTER CASH RETURN</a>
                                      <a class="nav-link" href="countercashreceive.php">COUNTER CASH RECEIVE</a>
                                      <a class="nav-link" href="patientwisedoctorreport.php">PATIENT WISE DOCTOR REPORT</a>
                                      <a class="nav-link" href="doctorconsultingpaymentreport.php">DOCTOR CONSULTING PAYMENT REPORT</a>
                                      <a class="nav-link" href="doctorconsultingpaymentreport2.php">DOCTOR CONSULTING PAYMENT REPORT 2</a>
                                     </nav>
                                </div>
                                <div class="card-body">
                                    <div class="row">
